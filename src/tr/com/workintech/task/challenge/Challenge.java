package tr.com.workintech.task.challenge;
...
public class Challenge {
    public static void main(String[] args) {
        String metin = "Carroll began writing the manuscript of the story the next day, although that earliest version is lost. " +
        ...
        metin = metin.replaceAll("[.,!?\\*]", "").toLowerCase();
